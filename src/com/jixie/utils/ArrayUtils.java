...
public class ArrayUtils {
	...
	/**
	 * 转换List<String>或List<IListItem>为整型数组
	 */
	@SuppressWarnings("unchecked")
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static List filerList(List items, String[] arrCode, boolean excludes) {
		return filterList(items, arrCode, excludes);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static List filterList(List items, String[] arrCode, boolean excludes) {
		List<IListItem> list = new ArrayList<IListItem>();
		if (arrCode == null) {
			if (excludes)
				list.addAll(items);
